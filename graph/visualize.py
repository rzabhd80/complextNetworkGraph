        ...
        vertex_data.append(
            {
                ...
                "x_offset": table.get("coordinate_space", {})
                .get("original_image_offset_applied", {})
                .get("x"),
                "y_offset": table.get("coordinate_space", {})
                .get("original_image_offset_applied", {})
                .get("y"),
            }
        )
...
output_file = "table_structure_graph_no_word.graphml"
